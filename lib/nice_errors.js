...
const NICE_ERRORS = {
    ...
    NO_REPOS_CONFIGURED: fn => new NiceError("NoReposConfiguredError",
        `The configuration file, "${fn}", does not contain any Github
        repositories to monitor. It needs to list at least one repository
        under github_repositories, like this:

        \ngithub_repositories:
        \n- MeasureOSS/Measure

        Measure can only fetch details of contributions that happen in
        the listed repositories. It is not possible to track contributions
        made by a specific list of users across all of Github.`),
